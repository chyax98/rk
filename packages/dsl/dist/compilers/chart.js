...
import { validateChartType, validateChartTemplate } from '../renderer-validation.js';
import { pos, excerpt, rawDirectiveBody, directiveBodyText, plainText, diag } from '../helpers.js';
/**
 ...
 *   :::
 */
export function compileChart(node, attrs, source, errors, file) {
    const columns = [];
    const rows = [];
...
function parseBodyAsPipeTable(body) {
