 ...
 */
export declare const RECIPES: Record<string, import('./contracts.ts').Recipe>;
/**
 * Get a recipe by surface name. Returns null if unknown.
 */
export declare function getRecipe(surface: string): import('./contracts.ts').Recipe | null;
/**
 * List all available recipe surface keys.
 */
export declare function listRecipeSurfaces(): string[];
export declare function getDesignRecommendation(surface?: string): import('./contracts.ts').DesignRecommendation | null;
