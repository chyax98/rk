import { listDesignResources } from './design-assets.ts.js';
import { BLOCK_ALIASES } from './contracts.ts.js';
export * from './contracts.ts.js';
export * from './design-assets.ts.js';
...
function resourcesForSurface(surface, recipe) {
    ...
    if (recipe?.recommendedBlocks?.includes('diagram'))
        wanted.add('thesvg');
