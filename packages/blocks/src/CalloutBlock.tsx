...
const ICONS: Record<string, string> = {
  ...
  success:
    'M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2zm-1 13.4-3.7-3.7 1.4-1.4 2.3 2.3 4.9-4.9 1.4 1.4-6.3 6.3z',
...
export default function CalloutBlock({ tone = 'info', title, content, icon }: Props) {
  ...
  return (
    <aside
      className={`rk-callout rk-callout-${resolvedTone}`}
