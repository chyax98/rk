...
description: >-
  ...
  Covers theme selection, all 27 WC syntax, anti-slop design rules, and the
...
更新时间：2026-05-18（v2：+rk-card, rk-section, rk-diff, radar/funnel/gauge）
...
<!-- gauge: 仪表盘，单值 JSON { value, name?, min?, max? } -->
...
<!-- 简单 before/after（无 @@ hunk header 也可以）-->
<rk-diff lang="python" title="优化查询">
